...
<body style="background-color:#EDE8E8;">
    ...
    <br>
        <img src="../images/Pantalon_negro.jpg" align=right class="zoom" width="500" height="700" >
        <br>
        <p style = "font-family:courier,arial,helvética;"><font size="5">Pantalon de Vestir color Negro para mujer</font></p>
        <p style = "font-family:courier,arial,helvética;"><font size="5">Todas las Tallas</font></p>
        <h3>$MXN 180</h3>
        <form class="row g-3" method="GET" action="ventaPantalonNegro.php">
  <div class="col-md-6">
