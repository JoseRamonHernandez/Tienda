...
<body style="background-color:#EDE8E8;">
    ...
    <br>
        <img src="../images/Mono_girasoles.jpg" align=right class="zoom" width="500" height="700" >
        <br>
        <p style = "font-family:courier,arial,helvética;"><font size="5">Mono con estampado de girasoles para mujer</font></p>
        <p style = "font-family:courier,arial,helvética;"><font size="5">Todas las Tallas</font></p>
        <h3>$MXN 125</h3>
        <form class="row g-3" method="GET" action="ventaMonoGirasoles.php">
  <div class="col-md-6">
